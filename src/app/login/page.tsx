...
import { AmbientParticles } from "@/components/premium-ui";
...
export default function LoginPage() {
  ...
  // Spring configs
  const cardSpring = { type: "spring" as const, stiffness: 120, damping: 20 };
  const stagger = {
    hidden: { opacity: 0 },
    show: {
      opacity: 1,
          ...
          >
            ...
            <div className="relative bg-[#0c0c0f]/80 backdrop-blur-2xl border border-white/[0.06] rounded-2xl md:rounded-3xl p-7 sm:p-8 md:p-10 shadow-[0_0_80px_rgba(0,0,0,0.5)]">
              ...
              <motion.div
                ...
                transition={{ ...cardSpring, delay: 0.4 }}
              >
              ...
              >
                ...
                <motion.div variants={fadeUp}>
                  ...
                  <div className="relative group">
                    <User size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/25 group-focus-within:text-accent/70 transition-colors duration-300" />
                    <input
                      type="text"
                      required
                      value={username}
                      onChange={(e) => setUsername(e.target.value)}
                      className="w-full bg-white/[0.03] border border-white/[0.06] rounded-xl py-3.5 pl-11 pr-4 text-white placeholder:text-white/20 focus:outline-none focus:border-accent/30 focus:bg-white/[0.05] focus:shadow-[0_0_0_3px_rgba(255,61,113,0.08),inset_0_0_20px_rgba(255,61,113,0.03)] transition-all duration-300 text-sm"
                ...
                <motion.div variants={fadeUp}>
                  ...
                  <div className="relative group">
                    <Lock size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/25 group-focus-within:text-accent/70 transition-colors duration-300" />
                    <input
                      type={showPassword ? "text" : "password"}
                      required
                      value={password}
                      onChange={(e) => setPassword(e.target.value)}
                      className="w-full bg-white/[0.03] border border-white/[0.06] rounded-xl py-3.5 pl-11 pr-12 text-white placeholder:text-white/20 focus:outline-none focus:border-accent/30 focus:bg-white/[0.05] focus:shadow-[0_0_0_3px_rgba(255,61,113,0.08),inset_0_0_20px_rgba(255,61,113,0.03)] transition-all duration-300 text-sm"
                ...
                <motion.div variants={fadeUp} className="pt-1 md:pt-2">
                  <motion.button
                    ...
                    className="w-full relative overflow-hidden bg-accent hover:bg-accent/90 disabled:bg-accent/50 text-white font-semibold py-3.5 md:py-4 rounded-xl transition-all duration-300 text-sm shadow-[0_0_30px_rgba(255,61,113,0.2)] hover:shadow-[0_0_40px_rgba(255,61,113,0.35)] disabled:shadow-none group"
                  >
